...
abstract class ActiveQueryTest extends TestCase
{
    ...
    public function testGetAttributesExcept(): void
    {
        ...
        $attributes = $customer
            ->findOne(1)
            ->getAttributes(null, ['status', 'bool_status', 'profile_id']);

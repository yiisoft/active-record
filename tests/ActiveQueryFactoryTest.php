...
abstract class ActiveQueryFactoryTest extends TestCase
{
    ...
    {
        $builder = new QueryBuilder($this->arFactory->getConnection());
    ...
    public function testDeeplyNestedTableRelationWith(): void
    {
        ...
        $categoriesQuery = $this->arFactory->createQueryTo(Category::class);
    ...
    public function testJoinWith(): void
    {
        ...
        $order = $this->arFactory->createQueryTo(Order::class);
    ...
    public function testJoinWithVia(): void
    {
        ...
        $this->arFactory->getConnection()->getQueryBuilder()->setSeparator("\n");
    ...
    public function testUnlinkAllViaTable(): void
    {
        ...
        $orderItemsWithNullFKQuery = $this->arFactory->createQueryTo(OrderItemWithNullFK::class);
    ...
    public function testFilterTableNamesFromAliases($fromParams, array $expectedAliases): void
    {
        ...
        $aliases = $this->invokeMethod($this->arFactory->createAR(Customer::class), 'filterValidAliases', [$query]);
    ...
    {
        $dossierQuery = $this->arFactory->createQueryTo(Dossier::class);
        ...
        $dossier = $this->arFactory->createAR(Dossier::class);
    ...
    {
        $documentQuery = $this->arFactory->createQueryTo(Document::class);
    ...
    {
        $bitValueQuery = $this->arFactory->createQueryTo(BitValues::class);
    ...
    public function testUpdateAttributes(): void
    {
        ...
        $newOrder = $this->arFactory->createAR(Order::class);
    ...
    public function testUnlink(): void
    {
        ...
        $orderWithNullFKQuery = $this->arFactory->createQueryTo(OrderWithNullFK::class);
    ...
    public function testUnlinkAllAndConditionSetNull(): void
    {
        ...
        $orderWithNullFKInstance = $this->arFactory->createAR(OrderWithNullFK::class);
    ...
    {
        $customerA = ($this->arFactory->createQueryTo(Customer::class))->findOne(1);
        $customerB = ($this->arFactory->createQueryTo(Customer::class))->findOne(2);
        $this->assertFalse($customerA->equals($customerB));

        $customerB = ($this->arFactory->createQueryTo(Customer::class))->findOne(1);
        $this->assertTrue($customerA->equals($customerB));

        $customerA = ($this->arFactory->createQueryTo(Customer::class))->findOne(1);
        $customerB = ($this->arFactory->createQueryTo(Item::class))->findOne(1);
        $this->assertFalse($customerA->equals($customerB));
    }
}

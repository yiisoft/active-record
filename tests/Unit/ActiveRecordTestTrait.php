...
use Yiisoft\ActiveRecord\ActiveRecordEvent;
...
trait ActiveRecordTestTrait
{
    ...
    {
        /* @var $customerClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        $customerClass = $this->getCustomerClass();
        /* @var $this TestCase|ActiveRecordTestTrait */
        // find one
        $result = $customerClass::find();
        $this->assertInstanceOf(\Yiisoft\ActiveRecord\ActiveQueryInterface::class, $result);
        $customer = $result->one();
    ...
    public function testEquals()
    {
        /* @var $customerClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        $customerClass = $this->getCustomerClass();
        /* @var $itemClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
    ...
    public function testFindEager()
    {
        /* @var $customerClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        $customerClass = $this->getCustomerClass();
        /* @var $orderClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
    ...
    public function testLink()
    {
        /* @var $orderClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        /* @var $itemClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        /* @var $orderItemClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        /* @var $customerClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        $customerClass = $this->getCustomerClass();
        $orderClass = $this->getOrderClass();
    ...
    public function testUnlink()
    {
        ...
        /* @var $orderClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        $orderClass = $this->getOrderClass();
        /* @var $orderWithNullFKClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
        $orderWithNullFKClass = $this->getOrderWithNullFKClass();
        /* @var $orderItemsWithNullFKClass \Yiisoft\ActiveRecord\ActiveRecordInterface */
    ...
    public function testAfterFind()
    {
        ...
        $afterFindCalls = [];
        Event::on(\Yiisoft\ActiveRecord\BaseActiveRecord::class, ActiveRecordEvent::AFTER_FIND, function ($event) use (&$afterFindCalls) {
        ...
        Event::off(\Yiisoft\ActiveRecord\BaseActiveRecord::class, ActiveRecordEvent::AFTER_FIND);
    }
    ...
    public function testAfterRefresh()
    {
        ...
        $afterRefreshCalls = [];
        Event::on(\Yiisoft\ActiveRecord\BaseActiveRecord::class, ActiveRecordEvent::AFTER_REFRESH, function ($event) use (&$afterRefreshCalls) {
            /* @var $ar BaseActiveRecord */
            $ar = $event->target;
        ...
        $afterRefreshCalls = [];
        Event::off(\Yiisoft\ActiveRecord\BaseActiveRecord::class, ActiveRecordEvent::AFTER_REFRESH);
    }

...
use Yiisoft\ActiveRecord\Tests\Data\OrderWithNullFK;
...
//            ['applyAlias'], // $query->applyAlias('customer', 'id') // _aliases are currently not being populated
    ...
    public function testFindCompositeRelationWithJoin()
    {
        ...
        $this->assertInstanceOf('Yiisoft\ActiveRecord\Tests\Data\OrderItem', $orderItemNoJoin);

        $orderItemWithJoin = $orderItem->orderItemCompositeWithJoin;
        $this->assertInstanceOf('Yiisoft\ActiveRecord\Tests\Data\OrderItem', $orderItemWithJoin);
    }
    ...
    public function testFindSimpleRelationWithJoin()
    {
        ...
        $this->assertInstanceOf('Yiisoft\ActiveRecord\Tests\Data\Customer', $customerNoJoin);

        $customerWithJoin = $order->customerJoinedWithProfile;
        $this->assertInstanceOf('Yiisoft\ActiveRecord\Tests\Data\Customer', $customerWithJoin);
        ...
        $this->assertInstanceOf('Yiisoft\ActiveRecord\Tests\Data\Customer', $customerWithJoinIndexOrdered['user1']);
    }
...
//        $this->assertSame(false, $model->bool_col2);
    ...
    {
        $customer = new \Yiisoft\ActiveRecord\Tests\Data\CustomerWithAlias();
        $customer->id = 1;
